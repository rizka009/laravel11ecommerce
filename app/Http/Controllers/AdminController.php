...
class AdminController extends Controller
{
    ...
    {
        $destinatinPath = public_path('uploads/brands');
        $img = Image::read($image->path());
        $img->cover(124,124,"top");
        $img->resize(124,124,function($constraint){
            $constraint->aspectRatio();
        })->save($destinatinPath.'/'.$imageName);
    }
    ...
    public function brand_delete($id)
    {
        ...
        $brand->delete();
        return redirect()->route('admin.brands')->with('status','Brand has been deleted successdully!');
    }
    //category
    ...
    {
        $destinatinPath = public_path('uploads/categories');
        $img = Image::read($image->path());
        $img->cover(124,124,"top");
        $img->resize(124,124,function($constraint){
            $constraint->aspectRatio();
    ...
    public function category_delete($id)
    {
        ...
        $category->delete();
        return redirect()->route('admin.categories')->with('status','Category has been deleted successdully!');
    }
    //products
    ...
    {
        $destinatinPathThumbnails = public_path('uploads/products/thumbnails');
        $destinatinPath = public_path('uploads/products');
        $img = Image::read($image->path());
        ...
        $img->resize(104,104,function($constraint){
            $constraint->aspectRatio();
        })->save($destinatinPathThumbnails.'/'.$imageName);
    }
    ...
    public function product_delete($id)
    {
        ...
        $product->delete();
        return redirect()->route('admin.products')->with('status','Product has been deleted successdully!');
    }
    ...
    {
        $destinatinPath = public_path('uploads/slides');
        $img = Image::read($image->path());
        $img->cover(620,620,"top");
        $img->resize(620,620,function($constraint){
            $constraint->aspectRatio();
        })->save($destinatinPath.'/'.$imageName);
    }
