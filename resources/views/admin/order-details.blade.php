        ...
        <div class="main-content-wrap">
                        ...
                        <tr>
                            ...
                            <td colspan="5">
                                ...
                                @elseif ($order->status == 'canceled')
                                    <span class="bedge bg-danger text-white">Canceled</span>
                                @else
                                    <span class="bedge bg-warning text-white">Ordered</span>
                                @endif
                            </td>
                        </tr>
                    </table>
            ...
            <div class="wg-box mt-5">
                ...
                @if ($transaction->transfer_proof)
                    <div class="mt-4">
                        <img src="{{ asset($transaction->transfer_proof) }}" alt="Bukti Transfer" class="img-thumbnail"
                            style="max-width: 300px; max-height: 300px;">
                    </div>
                @else
                    <p class="text-muted mt-4">Bukti transfer belum diunggah.</p>
                @endif
            </div>
