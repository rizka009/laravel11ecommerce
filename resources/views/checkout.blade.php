            ...
            <div class="row mt-5">
              <div class="col-md-6">
                <div class="form-floating my-3">
                  ...
                  @error('name')<span class="text-danger">{{ $messange }}</span>@enderror
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-floating my-3">
                  ...
                  @error('phone')<span class="text-danger">{{ $messange }}</span>@enderror
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-floating my-3">
                  ...
                  @error('zip')<span class="text-danger">{{ $messange }}</span>@enderror
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-floating mt-3 mb-3">
                  ...
                  @error('state')<span class="text-danger">{{ $messange }}</span>@enderror
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-floating my-3">
                  ...
                  @error('city')<span class="text-danger">{{ $messange }}</span>@enderror
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-floating my-3">
                  ...
                  @error('address')<span class="text-danger">{{ $messange }}</span>@enderror
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-floating my-3">
                  ...
                  @error('locality')<span class="text-danger">{{ $messange }}</span>@enderror
                </div>
              </div>
              <div class="col-md-12">
                <div class="form-floating my-3">
                  ...
                  @error('landmark')<span class="text-danger">{{ $messange }}</span>@enderror
                </div>
              </div>
            </div>
            @endif
